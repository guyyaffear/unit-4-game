$(document).ready(function(){ 
    ...
    $('.char2').on('click',function(){
        if(char1Count === true)
        {
            ...
            //Centers characters Health text
            $('.char4 p').css({'margin-left': '30px'});
            //put the css so they would appear the same as before it was clicked
            $('.starImage').css({'width': '100px',
                                'height': '100px',
                                'margin-left': 'auto',
                                'margin-right': 'auto',
    ...
    $('.char3').on('click',function(){
        if(char1Count === true)
        {
            ...
            $('.char4').appendTo('.enemiesBox').css({'height':'150px','width':'100px', 'background-color':'red'});
            $('.char4 p').css({'margin-left': '30px'});
            //take  the css propertes so they would appear the same as before it was clicked
            $('.starImage').css({'width': '100px',
                                'height': '100px',
                                'margin-left': 'auto',
                                'margin-right': 'auto',
    ...
    $('.char4').on('click',function(){
        ...
        else if(char1Count === false && maulCount === 0)
        {
            ...
            obiCount++;
            sidCount++;
            $('.char4').appendTo('.defenderBox').addClass("def").css({'background-color' : 'black', 'color':'white','color': "white"});
            //Centers Health text
            $('.char4 p').css({'margin-left': '30px'});
        }
    });
        $('.attackBtn').on('click',function() 
        {
            ...
            $('.defender').html('<p>' + 'You attacked ' + charName + 
                                ' for ' + attackMain +  ' damage '+
                                 ...
                                 counterAttack + ' </p>').css({'font-size': '20px','text-align':'center','color': "white"});
